...
namespace RedSys.RFC.Core.Code
{
	public class CompareObjects
	{
		...
		public bool Compare(object object1, string object1type, string comparetype, string value)
		{
			...
			Type t2 = Type.GetType(object1type);
		...
		private bool CompareString(object object1, string object1type, string comparetype, string value)
		{
			bool retBool = false;
		...
		private bool CompareInt(object object1, string object1type, string comparetype, string value)
		{
			bool retBool = false;
		...
		private bool CompareBool(object object1, string object1type, string comparetype, string value)
		{
			bool retBool = false;
		...
		private bool CompareDouble(object object1, string object1type, string comparetype, string value)
		{
			bool retBool = false;
		...
		private bool CompareDecimal(object object1, string object1type, string comparetype, string value)
		{
			bool retBool = false;
