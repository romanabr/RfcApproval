...
namespace RedSys.Common.Workflow
{
    public static class Constant
    {
        ...
        public static Guid Role_Ref = new Guid("CA416A1D-3B7A-40CA-997E-BAF9524EEAAE");
        ...
        public static Guid SkipPermissions = new Guid("43527DAA-0F22-414B-9A02-7101A11F3AA8");
        ...
        public static Guid RepeatedUserAgreement = new Guid("E59BDD9E-8FE6-4322-A127-A83EBCAC75AA");
        ...
        public const string CreateTaskFieldName = "Создавать задачу";
        public const string RoleName = "Список ролей";
        public const string RoleDistributionName = "Пользователи и роли";
        public const string StageListName = "Список этапов";
        ...
        public const string TaskTypeFieldName = "";
        public const string DescriptionFieldName = "";
        public const string CurrentUsersFieldName = "Текущий исполнитель";
    }
}
